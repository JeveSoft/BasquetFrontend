...
export default function Registro() {
    ...
    function esValidoDelegado() {
        ...
        if (nombre === "") {
            ...
            if (hayNumero()) {
                valido = false
                toast("Nombre No Debe Contener Numeros", {
                    icon: "⚠️", duration: 3000, style: {
                        border: '2px solid #ff7c01',
                        padding: '10px',
                        color: '#fff',
        ...
        if (carnet === "") {
            ...
            if (carnet.length < 3 || carnet.length > 15) {
                valido = false
                toast("Carnet Identidad Invalido", {
                    icon: "⚠️", duration: 3000, style: {
                        border: '2px solid #ff7c01',
                        padding: '10px',
                        color: '#fff',
    ...
    const hayNumero = () => {
        ...
        if (nombre.includes('3')) {
            hay_numero = true
        }
        if (nombre.includes('4')) {
            hay_numero = true
        }
        if (nombre.includes('5')) {
            hay_numero = true
        }
        if (nombre.includes('6')) {
            hay_numero = true
        }
        if (nombre.includes('7')) {
            hay_numero = true
        }
        if (nombre.includes('8')) {
            hay_numero = true
        }
        if (nombre.includes('9')) {
            hay_numero = true
        }
        return hay_numero
    }
                    ...
                    <ContenedorRegistro>
                        ...
                        <DetalleUsuario>
                            ...
                            <BoxCampo>
                                ...
                                <InputBox type="number"  placeholder="Cantidad de Jugadores" required id="cantidadJugadores" onChange={(e) => { setCantidadJugadores(e.target.value) }} />
                            </BoxCampo>
                            <BoxCampo>
